...
class SVMModel:
    def __init__(self):
        ...
        self.stop_words = ['is', 'are', 'am', 'be', 'been', 'being', 'have', 'has', 'had', 'do', 'does', 'did', 'will', 'would', 'hall', 'hould', 'can', 'could', 'ay', 'ight', 'ust', 'hall', 'hould', 'will', 'would']
    ...
    def run(self):
        ...
        # Assume the CSV has two columns: 'ymptoms' and 'disease'
        X = df['text']
        y = df['label']
